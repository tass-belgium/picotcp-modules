...
START_TEST(deserialize_connack_test)
{
	...
	return_code = deserialize_connack(serializer, &test_case_1);
	ck_assert_msg( return_code == ERROR, "An error should be generated.\n");

	return_code = deserialize_connack(serializer, &test_case_2);
	ck_assert_msg( return_code == ERROR, "An error should be generated.\n");

	return_code = deserialize_connack(serializer, &test_case_3);
	ck_assert_msg( return_code == ERROR, "An error should be generated.\n");

	return_code = deserialize_connack(serializer, &test_case_4);
	ck_assert_msg( return_code == ERROR, "An error should be generated.\n");

	return_code = deserialize_connack(serializer, &test_case_5);
	...
	return_code = deserialize_connack(serializer, &test_case_6);
	ck_assert_msg( return_code == SUCCES, "No error should be generated.\n");
	ck_assert_msg( serializer->session_present == 1, "A Session present flag should be set.\n");
	ck_assert_msg( serializer->return_code == 0, "The return code should be 0.\n");

	return_code = deserialize_connack(serializer, &test_case_7);
	ck_assert_msg( return_code == SUCCES, "No error should be generated.\n");
	ck_assert_msg( serializer->session_present == 1, "A Session present flag should be set.\n");
	ck_assert_msg( serializer->return_code == 1, "The return code should be 1.\n");

	return_code = deserialize_connack(serializer, &test_case_8);
	ck_assert_msg( return_code == ERROR, "An error should be generated.\n");
	ck_assert_msg( serializer->session_present == 1, "A Session present flag should be set.\n");
